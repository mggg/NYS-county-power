...
OUTPUT_DIR = TOP_DIR / "MCMC_results_dyn_tau"
...
def main(
    ...
    with open(PKL_DIR / "NYS_counties_livingston_full.pkl", "rb") as f:
    ...
    file_name = f"Livingston_DYNTAU_MCMC_discrep_L1_lenburst_{burst_length}_iters_{n_bursts}_pop_{population}_T_{threshold}_id_{uuid}_dyn_fuzz_{random_fuzz_epsilon}.jsonl"
